...
A dev oriented pastebin like container for sharing code and text. A lot more usefull though, thanking [John Crepezzi](https://github.com/seejohnrun) and [mko-x for the original repository](https://github.com/mko-x/docker-pastebin). Paste your stuff however :)

# Quickstart

## Run
```bash
docker run --name pastebin -p 80:80 sandlayth/arm-pastebin
```

## Compose
```yaml
pastebin:
  image: sandlayth/arm-pastebin
```
# Settings
